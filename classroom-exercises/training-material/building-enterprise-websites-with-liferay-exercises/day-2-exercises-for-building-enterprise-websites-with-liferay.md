...
* [Exercise 11: Generating Content with ChatGPT](#exercise-11-generating-content-with-chatgpt)
* [Bonus Exercise: Auto-Tagging Content](#bonus-exercise-auto-tagging-content)
...
## Exercise 11: Generating Content with ChatGPT

Liferay provides an AI creator feature for generating web content using ChatGPT. Here, you’ll add an API key to your instance and use this feature to create a web content article as the Clarity Admin user.
...
1. Enter the ChatGPT API key provided for this training.
...
1. Click the *AI Creator* button (![AI Creator Button](./../../../../../dxp/latest/en/images/icon-ai-creator.png)) to generate content with ChatGPT.
...
## Bonus Exercise: Auto-Tagging Content

**Challenge**:

Enable auto-tagging for new or updated web content using OpenNLP.

**Requirements**:

* Enable auto-tagging for new and updated assets in your instance.
* Enable the OpenNLP provider for web content.
* Enable the TensorFlow image auto-tagging.

**Success Criteria**:

The instance automatically adds tags to new or updated web articles based on their content.
...
You have now defined and assigned categories to your FAQ web content. Next, you'll learn how to display Clarity’s content with collections.

## Exercise 13a: Creating a Manual Collection

Liferay Collections are lists of content items that you can display in your site pages. You can group different content types together, making it easier to find and display related items. Each list can be defined manually or dynamically.
...
1. Select the *Header Announcement Bar* container and configure this setting:
   ...
   **Note**: Color options are defined by the theme's style book. Unless you apply a theme CSS client extension to the master page template, the Color Brand Primary option appears purple. This value is overridden in site pages by the Theme CSS client extension.
...
Here you'll create a catalog for Clarity's products as Clarity Admin.
...
Here you'll add product specifications as Clarity Admin.
...
Here you'll add products to Clarity's catalog, apply specifications and more as Clarity Admin.
...
1. Click *Create*.
   ...
   This generates your content.

1. Click *Add* to copy the response into the Full Description field. Alternatively, click *Try Again* to generate a new response.
...
1. Click *New* (![Add Button](./../../../../../dxp/latest/en/images/icon-add.png)) and select *Add an Existing Specification*.

1. Enter these values for the fields:

   | Field         | Value          |
   |:--------------|:---------------|
   | Specification | Frame Material |
   | Value         | `Metal`        |

1. Repeat steps 12-13 for the other specifications:
...
Here you'll create a channel and link it to Clarity's public enterprise website as Clarity Admin.
...
1. In the General tab, select B2B for the Commerce Site Type drop-down.

   ![In the General tab, select B2B under Commerce Site Type drop-down.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/07.png)
...
Here you'll finish setting up each page as Clarity Admin.
...
1. Select the widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.
...
1. Click *Save* and close the modal window.
   ...
   ![The Clarity Products categories should appear after saving.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/08.png)
...
1. In your training workspace, go to the `classroom-exercises/lesson-14/` folder and open the `commerce-category-navigation-cards.ftl` file.
...
![Use a display template for the Clarity Category Cards widget.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/09.png)
...
1. In your training workspace, go to the `classroom-exercises/lesson-14/` folder and open the `commerce-search-results-cards.ftl` file.
...
1. Select the Search Results widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.

   **Note**: The Search Results widget should look blank, towards the bottom right side of the layout.

   ![The Search Results widget should look blank.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/10.png)
...
1. Return to the *Products* page and click one of the category cards to confirm it is working properly and you are seeing your new template.
   ...
   ![The Search Results widget should now display the products.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/11.png)
...
1. In the *Page Templates* application, go to the *Display Page Templates* tab, click *New*, and select *Display Page Template*.
...
1. Drag and drop the *Product Details Page* fragment composition into the drop area.
   ...
   ![Drag and drop the Product Details Page fragment composition into the drop area.](./day-2-exercises-for-building-enterprise-websites-with-liferay/lesson14/images/12.png)
...
1. In your browser's navigation bar, copy down the category's ID that appears in the page URL. For example, `...categories_admin/vocabulary/37819/category/[category-id]`.
...
1. For file field, click *Choose File* and select `glasses-book.png` from the `[repository-folder]/classroom-exercises/lesson-15/` folder.
...
1. In your training workspace, open the `blog-entry.json` file in the `classroom-exercises/lesson-15/` folder.
...
1. In your training workspace, open the `import-web-content-articles-batch.json` file in the `classroom-exercises/lesson-15/` folder.
...
1. In your training workspace, open the `import-products-batch.json` file in the `classroom-exercises/lesson-15/` folder.
...
1. In your browser's navigation bar, copy down the vocabulary's ID that appears in the page URL. For example, `(...)categories_admin/vocabulary/[vocabulary-id]`.
...
1. In your training workspace, open the `import-taxonomy-categories-batch.json` file in the `classroom-exercises/lesson-15/` folder.
...
Great! You've leveraged Liferay's Headless APIs to migrate Clarity's legacy data. Next, you'll learn about Liferay's publishing tools and workflow.
...
1. Click *Back* (![Back](./../../../../../dxp/latest/en/images/icon-angle-left.png)) to return to the Publications application page.
...
1. Repeat steps 2-3 to invite Clara Murphy using these values:
...
1. Sign in as Christian Carter.
   ...
   **Note**: The publications menu now appears at the top of the page and a new notification for the publication invitation was received.
...
1. Expand the *Submit for Workflow* drop-down and select *Submit for Workflow with Permissions*.
...
1. Select the first Category Facet widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.
...
1. For Category Parameter Name, enter `category-region`.
...
1. Repeat steps 12-18 for the other category facet widgets:

   | Widget | Display Template        | Category Parameter Name  | Vocabulary    |
   |:-------|:------------------------|:-------------------------|:--------------|
   | Second | Clarity Search Category | `category-location`      | Location      |
   | Third  | Clarity Search Category | `category-job-positions` | Job Positions |
...
1. Select the Search Options widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.
...
1. Select the new Category Facet widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.
...
1. Select the Custom Filter widget, click *Actions* (![Actions Button](./../../../../../dxp/latest/en/images/icon-actions.png)) in the widget’s tooltip, and select *Configuration*.
...
As part of their organic growth strategy, Clarity wants to develop and train associates to further expand their business. To support this initiative, they want to prioritize associate-level positions on the Open Positions results page.

Here, you’ll create a search blueprint to boost associate-level job listings as the Clarity Admin user.
...
1. For Title, enter `Boost Associate Job Listings`.
...
1. In the right side menu, search for `Boost All Keywords Match` and click *Add* for the element.

1. For the Text to Match field, enter `Associate`.
...
1. In the Boost All Keywords Match element, change `Associate` to `VP` and click *Refresh* in the search preview to see the filter applied.

1. Change the value back to `Associate`.
...
1. For Blueprint, click *Select* and select the *Boost Associate Job Listings* blueprint.

1. Click *Save* and close the window.

   With the blueprint applied, the page doesn't need the Type Facet and Custom Filter widgets to filter the results.

1. Remove the Type Facet and Custom Filter widgets.

1. Click *Publish*.

   Now the search results prioritize displaying associate job listings.
...
1. Click *New* and select *Primary Master Page*.
...
1. In your training workspace, open the `filter-future-events.json` file in the `classroom-exercises/lesson-18/` folder.
...
1. Go to the *Calendar* page and start editing it.

1. From the *Fragments and Widgets* panel, drag and drop a *Container* fragment above the Calendar widget.
...
1. Click *Feature Flags* and go to the *Release* tab.

1. Enable *Search Headless API (LPS-179669)*.

1. Open a new browser window and access Liferay's API Explorer at http://localhost:8080/o/api.

1. Click the *REST Applications* drop-down menu and select *search/v1.0*.
...
1. In your training workspace, open the `api-post-search.json` file in the `classroom-exercises/lesson-18/` folder.
...
Congratulations! You've completed all exercises for day two of Building Enterprise Websites with Liferay.